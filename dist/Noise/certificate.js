...
import { readFields, fieldBytes, fieldString, fieldInt, encodeBytes, } from "../WAProto/protobuf.js";
...
export function parseCertificateDetails(details) {
    try {
 ...
 */
export function parseNoiseCertificate(payload) {
 ...
 */
export function validateNoiseCertificate(payload, trustedKeys = []) {
...
export function isStrictCertEnabled() {
...
export function encodeNoiseCertificateForTest(details, signature) {
