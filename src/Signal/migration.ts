...
export async function loadStoreMeta(folder: string): Promise<StoreMeta> {
  try {
...
export async function saveStoreMeta(folder: string, meta: StoreMeta): Promise<void> {
 ...
 */
export async function migrateSignalStore(folder: string): Promise<StoreMeta> {
