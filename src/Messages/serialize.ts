...
export function serializeMessage(msg: WAMessage): SerializedWAMessage {
  ...
  return {
    key: { ...msg.key },
    messageTimestamp: msg.messageTimestamp as number | string | null | undefined,
    status: msg.status as number | string | undefined,
...
export function deserializeMessage(data: SerializedWAMessage): WAMessage {
  ...
  return {
    key: { ...data.key },
    messageTimestamp: data.messageTimestamp as any,
    status: data.status,
