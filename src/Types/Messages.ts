...
type LongLike = number | { low: number; high: number; unsigned?: boolean };
...
export type AnyMessageContent =
  | { text: string; mentions?: string[]; linkPreview?: unknown }
  | { react: { text: string; key: WAMessageKey } }
  | { image: Buffer | Uint8Array | { url: string }; caption?: string; mimetype?: string }
  | { video: Buffer | Uint8Array | { url: string }; caption?: string; mimetype?: string }
  | { audio: Buffer | Uint8Array | { url: string }; mimetype?: string; ptt?: boolean }
  | { document: Buffer | Uint8Array | { url: string }; mimetype?: string; fileName?: string }
  | { sticker: Buffer | Uint8Array | { url: string }; mimetype?: string }
  | {
      location: {
        degreesLatitude: number;
        degreesLongitude: number;
