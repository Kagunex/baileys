...
export type WASocket = {
  ...
  readonly user?: { id: string; name?: string; lid?: string } | undefined;

  sendMessage(
    jid: string,
    content: AnyMessageContent | import("./Messages.js").WAMessageContent,
  ...
  waitForConnectionUpdate(
    check: (update: ConnectionUpdate) => boolean | undefined,
    timeoutMs?: number,
  ): Promise<void>;
};
