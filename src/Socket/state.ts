...
export type InternalSocketState = {
  connection: ConnectionState; qr?: string; isNewLogin?: boolean;
  lastDisconnect?: ConnectionUpdate["lastDisconnect"];
  auth?: AuthenticationState; user?: { id: string; name?: string; lid?: string };
};
export function createInitialState(auth?: AuthenticationState): InternalSocketState {
